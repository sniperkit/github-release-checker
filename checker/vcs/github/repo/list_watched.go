...
func listWatchedAll(activity *github.ActivityService, repoChan chanW, wg *sync.WaitGroup) error {
	firstPage := 1
...
func listWatched(activity *github.ActivityService, page int, repoChan chanW) (*github.Response, error) {
