...
func listFollowerAll(activity *github.ActivityService, repoChan chanW, wg *sync.WaitGroup) error {
	firstPage := 1
...
func listFollower(activity *github.ActivityService, page int, repoChan chanW) (*github.Response, error) {
